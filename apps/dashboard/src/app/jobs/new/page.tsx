...
const jobSchema = z.object({
  ...
  maxResults: z.number().min(10).max(5000).default(500),
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch h-full">
        ...
        <div className="flex flex-col gap-2 relative" ref={dropdownRef}>
          ...
          <div className="relative">
            <input
              ...
              className={`w-full bg-bg-primary border rounded-xl px-4 py-4 pr-12 text-lg font-medium text-text-primary placeholder:text-text-muted focus:outline-none focus:ring-2 transition-all shadow-sm ${
                errors.keyword ? "border-error focus:ring-error/20" : "border-border-color focus:border-accent-primary focus:ring-accent-primary/20"
              }`}
            />
            <div 
        ...
        <div className="flex flex-col gap-2">
          ...
          <input
            ...
            {...register("location")}
            className={`w-full bg-bg-primary border rounded-xl px-4 py-4 text-text-primary placeholder:text-text-muted focus:outline-none focus:ring-2 transition-all shadow-sm ${
              errors.location ? "border-error focus:ring-error/20" : "border-border-color focus:border-accent-primary focus:ring-accent-primary/20"
            }`}
          />
        ...
        <button
          ...
          className="mt-2 bg-accent-primary hover:bg-accent-hover text-white font-bold px-6 py-4 rounded-xl transition-all shadow-lg hover:shadow-xl flex justify-center items-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed uppercase tracking-wider text-sm"
        >
