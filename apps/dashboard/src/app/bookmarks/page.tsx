...
export default function BookmarksPage() {
  ...
  const exportToCSV = () => {
    ...
    link.href = url;
    link.setAttribute('download', `bookmarked_leads_export_${new Date().toISOString().split('T')[0]}.csv`);
    ...
    <div className="flex flex-col gap-8 max-w-[1400px] mx-auto h-full relative">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div className="flex flex-col gap-1 shrink-0">
          ...
          <p className="text-gray-500">View and manage your saved prospects.</p>
        </div>
